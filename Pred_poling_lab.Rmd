...
```{r}
ggplot() +
      geom_sf(data = vars_net, aes(fill=HH_inc), colour="#000000") +
      scale_fill_viridis(name="Median Household Income") +
...
ggplot() +
      geom_sf(data = vars_net.longNn, aes(fill=value)) +
      scale_fill_viridis(name="NN Distance") +
...
```{r}
#ggplot() +
#  geom_point(data=final_net, x=as.numeric("HH_inc"), #y="countVandalism")

plot(data=final_net, x="Vacant_Bldgs" , y="countVandalism")
```
